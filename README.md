...
## Custom Progression Timeline

Define exact item builds for up to 20 stages using local configuration files.

## Dynamic Configuration Parser

Parses complex configuration strings (ItemName, Count;) and maps them to in-game indices at runtime.

## Tier-Based Blacklisting

Compiles a static memory cache of banned items on startup to filter random drop pools.
...
Core APIs: System.Reflection, System.Linq (LINQ queries)
monsterInv.CleanInventory();
